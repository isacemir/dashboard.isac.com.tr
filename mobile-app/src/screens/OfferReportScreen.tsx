...
export const OfferReportScreen: React.FC = () => {
  ...
  const rawData = useMemo(() => DataService.getOfferReports(), []);
      ...
      <View style={styles.card}>
        <View style={styles.cardHeader}>
          <View style={styles.cardIconWrap}>
            <MaterialIcons name="description" size={20} color="#006290" />
          </View>
        ...
        <View style={styles.metricsRow}>
          ...
          <View style={styles.metric}>
            <Text style={styles.metricLabel}>Birim Fiyat</Text>
          ...
          <View style={styles.metricDivider} />
          <View style={styles.metric}>
            <Text style={styles.metricLabel}>TL Toplam</Text>
  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <Header title="ISAC Sense Digital" subtitle="Teklif Raporları" onMenuPress={() => setDrawerOpen(true)} onNotificationPress={() => (navigation as any).navigate("Notifications")} onProfilePress={() => (navigation as any).navigate("Profile")} />
      ...
      <View style={styles.searchWrap}>
        ...
        <TextInput style={styles.searchInput} placeholder="Müşteri, teklif no, ürün veya marka ara..." placeholderTextColor="#94a3b8" value={search} onChangeText={setSearch} />
